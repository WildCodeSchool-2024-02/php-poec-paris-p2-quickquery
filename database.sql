...
VALUES (
        ...
        'Im trying to learn about the loops and the addition assignments such as ++, +=, *=... etc The problem is I don\'t get the logic of it completely if (x+=y = x + y).\r\n\r\nWhy in the sum= 0 the result is 6 and sum = number is 11? I dont get where this 6 comes from. Do you know a nice resource to help me on this? Thank you!',
        '2024-06-04 13:30:00',
        '2024-06-04 10:35:33',
        1
    ),
    (
        ...
        'Ca decal toujours vers la gauche je comprends pas',
        '2024-06-04 18:00:00',
        '2024-06-04 10:37:14',
        1
    ),
    (
        39,
        'Comment appeler une API avec JS',
        'Je suis debutant en JS et PHP et l\'erreur me met : \r\n#Error\r\n#define YYJSON_TYPE_NONE\r\n((uint8_t)0)',
        '2024-06-04 13:30:00',
        '2024-06-04 10:38:36',
        1
    ),
    (
        40,
        'Comment générer des input SQL ?',
        'Je dois générer des contenus pour mon site web, y\'a qlqun pour m\'aider svp ?  je suis debutant pitié :)',
        '2024-06-04 16:00:00',
        '2024-06-04 10:40:11',
        1
    ),
    ...
    (
        42,
        'Les startups de logiciels qui ont besoin de $ peuvent-elles éviter le capital-risque ?',
        'L\'épisode d\'aujourd\'hui est une conversation avec Benjamin Shestakofsky, professeur adjoint de sociologie à l\'Université de Pennsylvanie, qui se concentre sur la manière dont les technologies numériques affectent le travail et l\'emploi, les organisations et les échanges économiques.',
        '2024-06-04 19:00:00',
        '2024-06-04 10:42:49',
        1
    );
...
VALUES (
        ...
        'Pierre',
        'jobrider@gmail.com',
        '$2y$10$e/2wTz5aPbW6DA9z1.zPueDzy8qX4T/9szq1y47QRO.Ds2LGwktHa'
    ),
    (
        2,
        'Samy',
