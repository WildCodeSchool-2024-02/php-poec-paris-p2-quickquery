...
class QuestionManager extends AbstractManager
{
    ...
    {
        $statement = $this->pdo->prepare("INSERT INTO " . self::TABLE . " (`title`, `description`, `scheduled_at`, `created_at`,`author`) VALUES (:title, :description, :scheduled_at, NOW(), 1)");
    ...
    {
        $statement = $this->pdo->prepare("INSERT INTO question_tag (question_id, tag_id) VALUES (:question_id, :tag_id)");
